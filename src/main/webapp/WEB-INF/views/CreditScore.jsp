...
<html>
  <head>  
    <title>AngularJS + Spring Boot - This should work with OJET Similarly!</title>  
  ...
  <body ng-app="myApp" class="ng-cloak">
      <div class="generic-container" ng-controller="CreditController as ctrl">
          <div class="panel panel-default">
              <div class="panel-heading"><span class="lead">Darwin Customer Credit Score - @@NAMESPACE@@</span></div>
